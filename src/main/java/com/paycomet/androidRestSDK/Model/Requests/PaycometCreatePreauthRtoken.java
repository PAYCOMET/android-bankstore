...
public class PaycometCreatePreauthRtoken extends PaycometMerchant {
    ...
    public PaycometCreatePreauthRtoken() {}

    public PaycometCreatePreauthRtoken(String amount, String order, String currency, String authCode, String methodId, String challengeUrl) {
